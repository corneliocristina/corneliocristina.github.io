...
* **RECOVER** - A neuro-symbolic framework for failure detection and recovery in robotics
  ...
  * More info on [RECOVER website](https://recover-ontothor.github.io)
* **AI-Descartes** - A tool for automated scientific discovery that combines logical reasoning and symbolic regression.
  * Published in [Nature Communications](https://www.nature.com/articles/s41467-023-37236-y)
  * More info on [AI-Descarted website](https://ai-descartes.github.io/) 
* **NASR** - **N**eural **A**ttention for **S**ymbolic **R**easoning 
  * ICLR23 - *Learning where and when to reason in neuro-symbolic inference*
  * More info on [NASR webpage](https://github.com/corneliocristina/NASR) 
* **DECK** - **DEC**eased **K**idney exchange program
  ...
  * More info on [DECK webpage](DECK.md)
* **RuDaS** - **S**ynthetic **Da**tasets for **Ru**le Learning and Evaluation Tools
  * More info on [RuDaS webpage](RuDaS.md)
...
* [**Logical conditional preference theories**](https://arxiv.org/abs/1504.06374), C. Cornelio, A. Loreggia, and V. Saraswat, Proceedings of the MPREF workshop of the International Joint Conference on Artificial Intelligence 2015, IJCAI-15.
...
<a id="patents"></a>
## Patents
* [**Neuro-Symbolic system for constraint-based error correction**](https://patents.google.com/patent/US20240119712A1/), C. Cornelio, J. Stuehmer, T. Hospedales, 2023
